export const experiences = [
	{
		...
		technologies: ['Hono', '.NET 9', 'Typescript', 'Cloudflare', 'PostgreSQL', 'React', 'Docker'],
	},
	{
		company: 'Perituza Software Solutions',
		position: 'Information Technology Intern (.NET/ R&D)',
		duration: '2024 – 2025',
		location: 'Colombo, Sri Lanka',
		description: [
		...
		technologies: ['C#', '.NET', 'Azure DevOps', 'GitHub Actions', 'Docker', 'SQL'],
