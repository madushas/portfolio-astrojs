export const experiences = [
	{
		...
		technologies: ['C#', '.NET 9', 'Typescript', 'AWS', 'PostgreSQL', 'React', 'Docker'],
	},
	{
		...
		technologies: ['C#', 'ASP.NET Core', 'Azure', 'SQL Server', 'Next.js', 'TypeScript'],
	},
	{
		company: 'Perituza Lanka',
		...
		technologies: ['C#', '.NET', 'Azure DevOps', 'Docker', 'SQL'],
	...
	},
	{
		...
		technologies: ['Premiere Pro', 'After Effects', 'Adobe CC'],
		link: 'https://nibm.lk',
	},
];
